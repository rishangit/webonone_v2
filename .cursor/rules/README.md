...
| [loading-empty-states.mdc](loading-empty-states.mdc) | `**/frontend/src/**/*.{ts,tsx}` | `LoadingState` vs button `Spinner`; `ListEmptyState` with `itemType` |
...
| Loading and empty states (`LoadingState`, `ListEmptyState`) | [loading-empty-states.mdc](loading-empty-states.mdc) |
