...
- [details-page-wizard-edit.mdc](../../rules/details-page-wizard-edit.mdc) — Identity profile (per-card Edit → wizard); [skill](../details-page-wizard-edit/SKILL.md)
- [details-page-cards.mdc](../../rules/details-page-cards.mdc) — showcase/simple inline page-level Edit only ([details-page-cards skill](../details-page-cards/SKILL.md))
- [core-hosted-peer-dialog skill](../core-hosted-peer-dialog/SKILL.md) — profile edit wizard when embedded (`/embed/dialogs/profile/edit`)
