...
**Auto-run:** ClickUp MCP, git, and spec writes are pre-authorized — execute without waiting for approval. See `.cursor/permissions.json`. When part of `/clickup-run`, do not re-pick the task or ask to continue.
