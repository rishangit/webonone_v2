...
const SLUG = 'session_schedule_changed'
const BODY =
  '{{companyName}}: {{serviceName}} on {{sessionDate}} moved from {{previousSessionTime}} to {{sessionTime}}–{{sessionEndTime}} at {{location}}. Token {{tokenLabel}}.'
const REQUIRED_KEYS = [
  'userName',
  'companyName',
  'serviceName',
...
/**
 * Seed platform SMS template for session schedule-change notifications.
 */
