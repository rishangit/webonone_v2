...
const SLUG = 'session_token_issued'
const BODY =
  '{{companyName}}: your token for {{serviceName}} on {{sessionDate}} at {{sessionTime}} is {{tokenLabel}}.'
const REQUIRED_KEYS = [
  'userName',
  'companyName',
  'serviceName',
...
/**
 * Seed platform SMS template for event session queue token notifications.
 */
