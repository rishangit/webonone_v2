...
const SLUG = 'session_started'
const BODY =
  '{{companyName}}: {{serviceName}} on {{sessionDate}} at {{sessionTime}} has started. Your token is {{tokenLabel}}.'
const REQUIRED_KEYS = [
  'userName',
  'companyName',
  'serviceName',
...
/**
 * Seed platform SMS template for session-started notifications to token holders.
 */
