...
import { mapZodIssuesToFieldErrors as mapStaffZodIssues } from '@/features/staff/schemas/staffSchemas'
...
export function mapZodIssuesToFieldErrors(
  issues: z.ZodIssue[],
): Partial<Record<keyof StaffLeaveFormValues, string>> {
  return mapStaffZodIssues(issues) as Partial<Record<keyof StaffLeaveFormValues, string>>
}
