...
- **Subtask 86ey2yv18** — `StatusTag` component (pending / rejected / approved) with glass surface and semantic borders; new **Tags** showcase tab.
...
|---------|----------------|
| **UI Kit** (`ui-kit/`) | `ImagePreview`, `StatusTag`, dialog/phone showcase improvements |
...
| [04-status-tags.md](./04-status-tags.md) | `StatusTag` variants, glass styling, Tags showcase tab |
...
| UI-kit need to have the status tags | 86ey2yv18 | [04](./04-status-tags.md); Phase 5 |
