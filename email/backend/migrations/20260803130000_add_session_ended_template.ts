...
const TEMPLATE = {
  slug: 'session_ended',
  name: 'Session Ended',
  subject: '{{companyName}}: {{serviceName}} session has ended',
  requiredKeys: [
    'userName',
    'companyName',
    'serviceName',
...
<p>The <strong>{{serviceName}}</strong> session at {{companyName}} has ended.</p>
<p>Your token was: <strong>{{tokenLabel}}</strong></p>
<p>Session: {{sessionDate}} at {{sessionTime}}</p>
<p>Thank you for attending.</p>
{{footerHtml}}`,
  text_body: `Dear {{userName}}

The {{serviceName}} session at {{companyName}} has ended.

Your token was: {{tokenLabel}}
