...
const TEMPLATE = {
  slug: 'profile_email_verification_otp',
  name: 'Profile Email Verification OTP',
  subject: 'Verify your email',
  requiredKeys: ['userName', 'otp'],
  html_body: `<p>Dear {{userName}},</p>
<p>Use this code to verify the email address on your WebOnOne profile.</p>
<p>Your verification code is: <strong>{{otp}}</strong></p>
<p>This code expires in 1 minute. If you did not request this, ignore this email.</p>
{{footerHtml}}`,
  text_body: `Dear {{userName}}

Use this code to verify the email address on your WebOnOne profile.
