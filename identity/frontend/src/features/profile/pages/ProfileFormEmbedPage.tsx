...
import { parseProfileWizardStep } from '../schemas/profileSchemas'
import { ProfileFormDialog } from '../components/ProfileFormDialog'

/**
 * Body-only profile edit wizard for core-hosted peer dialog
 * (host owns Cancel / Previous / Save footer).
 */
export function ProfileFormEmbedPage() {
  ...
  const initialStep = parseProfileWizardStep(searchParams.get('step'))
