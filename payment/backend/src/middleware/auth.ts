...
import type { PaymentRole } from '../models/db.js'

export interface AuthenticatedRequest extends Request {
  user?: { id: string; email: string; role: PaymentRole; companyId: string | null }
}

type JwtClaims = {
  sub: string
  email: string
  platform_role?: PaymentRole
...
export function requireRole(...roles: PaymentRole[]) {
