...
<#
.SYNOPSIS
  Issue a Let's Encrypt wildcard cert for *.live.webonone.com and bind HTTPS in IIS.
...
param(
    ...
    [string]$WacsPath = '',
    [string]$FriendlyName = 'live-company-sites-wildcard'
)
...
Write-Host '(Host is typically _acme-challenge.live for *.live.webonone.com.)'
Write-Host ''
...
Write-Host ''
Write-Host "HTTPS ready: https://medi-clinic.live.webonone.com/"
