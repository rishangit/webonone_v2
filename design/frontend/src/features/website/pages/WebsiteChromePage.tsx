      ...
      <WebsiteHubTabs
        ...
        actions={
          <WebsiteHubListToolbar
            ...
            searchPlaceholder={kind === 'headers' ? t('searchHeaders') : t('searchFooters')}
            searchAriaLabel={kind === 'headers' ? t('searchHeaders') : t('searchFooters')}
            canManage={canManage}
            addLabel={kind === 'headers' ? t('addHeader') : t('addFooter')}
