...
import { ThemeCssImportDialog } from '../components/theme-editor/ThemeCssImportDialog'

export function WebsiteThemePaletteImportEmbedPage() {
  ...
  return (
    <ThemeCssImportDialog
      ...
      onImport={(swatches) => {
        sendPlatformPeerDialogComplete(parentOrigin, requestId, { swatches })
      }}
    />
  )
}
