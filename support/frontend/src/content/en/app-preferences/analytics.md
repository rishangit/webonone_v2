...
2. Open **Analytics**.
3. Pick a date range (last 7 days, 30 days, 90 days, or 12 months). Snapshot counts such as catalog size and staff are current, not limited to that range.

What you see depends on [role](/docs/getting-started/roles):

- **Company owner** — KPIs and charts for sales **revenue**, **profit**, catalog mix (products, services, spaces), payments, top customers, staff sales, and event or queue status.
- **Member or staff** — Progress, catalog counts, and event status. Revenue, profit, and customer spend are hidden.
- **Super Admin** — Platform totals: companies by status and new companies over time. Not one company’s POS.
