...
audience: owner
order: 1
summary: "Sales → POS වෙතින් products, services හෝ spaces විකිණීම සහ cash, card හෝ other ගෙවීම් ලබා ගැනීම."
---

1. සමාගමට login වන්න.
2. **Sales → POS** විවෘත කරන්න.
3. catalog අයිතම bill එකට එක් කරන්න.
