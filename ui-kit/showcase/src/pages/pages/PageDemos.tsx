...
import { Edit3, Globe, Mail, MapPin, Phone, Plus, User } from 'lucide-react'
import { z } from 'zod'
import {
  Button,
  Checkbox,
  ...
  return (
    ...
    >
      {mode === 'view' ? (
        ...
        <Form id="pages-details-form" onSubmit={handleSubmit} className="max-w-xl space-y-6">
          <section className="space-y-4">
            <h3 className="text-lg font-semibold">Name</h3>
            <div className="grid grid-cols-1 gap-4 sm:grid-cols-2">
              <FormField label="First name" htmlFor="pages-details-first-name" required error={errors.firstName}>
                <Input
              ...
              <FormField label="Last name" htmlFor="pages-details-last-name" required error={errors.lastName}>
                <Input
            ...
            <FormField label="Display name" htmlFor="pages-details-display-name" required error={errors.displayName}>
              <Input
